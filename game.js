...
async function displayLeaderboard() {
    ...
    try {
        ...
        if (leaderboardList) {
            leaderboardList.innerHTML = leaderboardHTML || '<div class="no-scores">No scores yet!</div>';
        }
        if (miniLeaderboard) {
            miniLeaderboard.innerHTML = leaderboardHTML || '<div class="no-scores">No scores yet!</div>';
        }
    } catch (error) {
        console.error('Error displaying leaderboard:', error);
        const errorMessage = '<div class="error">Error loading leaderboard</div>';
